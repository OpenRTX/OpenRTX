...
class MK22FlexTimer0 : public TimerAdapter<MK22FlexTimer0, 32>
{
public:
    ...
    static unsigned int IRQTimerFrequency()
    {
        ...
        // the CPU frequency.
        // Then divide by the prescaler
        return SystemCoreClock >> (FTM0->SC & FTM_SC_PS_MASK);
    }
