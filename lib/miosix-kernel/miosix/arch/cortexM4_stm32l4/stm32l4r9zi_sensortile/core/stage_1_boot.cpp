 ...
 * startup.cpp
 * STM32 C++ startup.
 * NOTE: for stm32l4r9zi devices ONLY.
...
void __attribute__((weak)) OCTOSPI1_IRQHandler();
...
void __attribute__((weak)) OCTOSPI2_IRQHandler();
...
void __attribute__((weak)) GFXMMU_IRQHandler();
