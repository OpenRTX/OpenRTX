...
Demodulator::Demodulator() : newFrame(false)
{
}
...
ssize_t Demodulator::getFrame(void *buf, size_t size)
{
    // Frame is consumed in any case
    newFrame = false;
    ...
    return static_cast<ssize_t>(frame.len);
}

bool Demodulator::DCD()
{
