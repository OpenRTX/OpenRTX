...
void _ui_drawModeVFOFreq()
{
    ...
    gfx_printLine(
        1, 3, layout.top_h, SCREEN_HEIGHT - layout.bottom_h,
        layout.horizontal_pad, layout.mode_font_big, TEXT_ALIGN_CENTER,
...
void _ui_drawModeDetails(ui_state_t* ui_state)
{
    ...
    switch (last_state.channel.mode)
    {
        ...
        case M17:
            ...
            gfx_printLine(2, 3, layout.top_h, SCREEN_HEIGHT - layout.bottom_h,
                          layout.horizontal_pad, layout.mode_font_small,
                          TEXT_ALIGN_LEFT, color_white, "Src ID: %s",
                          cfg.source_address);
            // Print M17 Destination ID on line 3 of 3
            if (ui_state->edit_mode)
            {
                gfx_printLine(3, 3, layout.top_h,
                              SCREEN_HEIGHT - layout.bottom_h,
                              layout.horizontal_pad, layout.mode_font_small,
                              TEXT_ALIGN_LEFT, color_white, "Dst ID: %s_",
            ...
            else
            {
                gfx_printLine(3, 3, layout.top_h,
                              SCREEN_HEIGHT - layout.bottom_h,
                              layout.horizontal_pad, layout.mode_font_small,
                              TEXT_ALIGN_LEFT, color_white, "Dst ID: %s",
