...
void color_picker_draw() {
    ...
    gfx_printLine(1, 4, layout.top_h, SCREEN_HEIGHT - layout.bottom_h,
              ...
              TEXT_ALIGN_CENTER, modified_color, "Color");
    ...
    switch (current_column) {
        case COLUMN_RED:
            sample_color = (color_t) {modified_color.r, 0, 0, 255};
            break;
        case COLUMN_GREEN:
            sample_color = (color_t) {0, modified_color.g, 0, 255};
            break;
        case COLUMN_BLUE:
            sample_color = (color_t) {0, 0, modified_color.b, 255};
            break;
        case COLUMN_ALPHA:
            sample_color = (color_t) {modified_color.r, modified_color.g, modified_color.b, 255};
            break;
    }
