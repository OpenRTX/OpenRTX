...
void ui_States_MenuUp( GuiState_st* guiState , uint8_t menu_entries )
{
    if( guiState->uiState.menu_selected > 0 )
    {
        guiState->uiState.menu_selected -= 1 ;
...
void ui_States_MenuDown( GuiState_st* guiState , uint8_t menu_entries )
{
