...
void _ui_drawMenuListValue( ui_state_st* uiState , uint8_t selected ,
...
void _ui_drawMenuTop( ui_state_st* uiState )
{
    gfx_clearScreen();
    ...
    // Print menu entries
    _ui_drawMenuList(uiState->menu_selected, _ui_getMenuTopEntryName);
}

void _ui_drawMenuBank( ui_state_st* uiState )
{
    gfx_clearScreen();
    ...
    // Print bank entries
    _ui_drawMenuList(uiState->menu_selected, _ui_getBankName);
}

void _ui_drawMenuChannel( ui_state_st* uiState )
{
    gfx_clearScreen();
    ...
    _ui_drawMenuList(uiState->menu_selected, _ui_getChannelName);
}

void _ui_drawMenuContacts( ui_state_st* uiState )
{
    gfx_clearScreen();
...
void _ui_drawMenuSettings( ui_state_st* uiState , event_t* event )
{
    (void)event ;
    ...
    // Print menu entries
    _ui_drawMenuList(uiState->menu_selected, _ui_getSettingsEntryName);
}

void _ui_drawMenuBackupRestore( ui_state_st* uiState , event_t* event )
{
    (void)event ;
    ...
    // Print menu entries
    _ui_drawMenuList(uiState->menu_selected, _ui_getBackupRestoreEntryName);
}

void _ui_drawMenuBackup( ui_state_st* uiState , event_t* event )
{
    (void)uiState ;
    (void)event ;
...
void _ui_drawMenuRestore( ui_state_st* uiState , event_t* event )
{
    (void)uiState ;
    (void)event ;
...
void _ui_drawMenuInfo( ui_state_st* uiState , event_t* event )
{
    (void)event ;
    ...
    // Print menu entries
    _ui_drawMenuListValue(uiState, uiState->menu_selected, _ui_getInfoEntryName,
...
void _ui_drawSettingsDisplay( ui_state_st* uiState , event_t* event )
{
    (void)event ;
    ...
    _ui_drawMenuListValue(uiState, uiState->menu_selected, _ui_getDisplayEntryName,
                           _ui_getDisplayValueName);
}

#ifdef GPS_PRESENT
void _ui_drawSettingsGPS( ui_state_st* uiState , event_t* event )
{
    (void)event ;
    ...
    // Print display settings entries
    _ui_drawMenuListValue(uiState, uiState->menu_selected,
...
void _ui_drawSettingsTimeDateSet( ui_state_st* uiState , event_t* event )
{
    (void)event ;
...
void _ui_drawSettingsM17( ui_state_st* uiState , event_t* event )
{
    (void)event ;
    ...
    {
        _ui_drawMenuListValue(uiState, uiState->menu_selected, _ui_getM17EntryName,
                              _ui_getM17ValueName);
    }
}

void _ui_drawSettingsVoicePrompts( ui_state_st* uiState , event_t* event )
{
    (void)event ;
    ...
    _ui_drawMenuListValue(uiState, uiState->menu_selected, _ui_getVoiceEntryName,
                           _ui_getVoiceValueName);
}

void _ui_drawSettingsReset2Defaults( ui_state_st* uiState , event_t* event )
{
    (void)uiState ;
    (void)event ;
...
void _ui_drawSettingsRadio( ui_state_st* uiState , event_t* event )
{
    (void)event ;
    ...
    else
    {
        ...
        _ui_drawMenuListValue(uiState, uiState->menu_selected, _ui_getRadioEntryName,
...
bool _ui_drawMacroMenu( ui_state_st* uiState , event_t* event )
{
    (void)event ;
 ...
 */
        ...
        if( uiState->macro_menu_selected == 0 )
        {
            ...
            gfx_print(layout.line1_pos, layout.top_font, TEXT_ALIGN_LEFT, yellow_fab413, "1");
            gfx_print(layout.line1_pos, layout.top_font, TEXT_ALIGN_LEFT, color_white, "   T-");
            gfx_print(layout.line1_pos, layout.top_font, TEXT_ALIGN_LEFT, color_white, "     %7.1f" , ctcss_tone[last_state.channel.fm.txTone]/10.0f);
#ifdef UI_NO_KEYBOARD
        }
#endif // UI_NO_KEYBOARD
#ifdef UI_NO_KEYBOARD
        ...
        {
#endif // UI_NO_KEYBOARD
            gfx_print(layout.line1_pos, layout.top_font, TEXT_ALIGN_CENTER, yellow_fab413, "2");
            gfx_print(layout.line1_pos, layout.top_font, TEXT_ALIGN_CENTER, color_white,   "       T+");
#ifdef UI_NO_KEYBOARD
        }
#endif // UI_NO_KEYBOARD
    }
    else
    {
        ...
        {
            gfx_print(layout.line1_pos, layout.top_font, TEXT_ALIGN_LEFT, yellow_fab413, "1");
            gfx_print(layout.line1_pos, layout.top_font, TEXT_ALIGN_LEFT, color_white, "          ");
            gfx_print(layout.line1_pos, layout.top_font, TEXT_ALIGN_CENTER, yellow_fab413, "2");
        }
    }
#ifdef UI_NO_KEYBOARD
    ...
    {
#endif // UI_NO_KEYBOARD
        gfx_print(layout.line1_pos, layout.top_font, TEXT_ALIGN_RIGHT, yellow_fab413, "3        ");
#ifdef UI_NO_KEYBOARD
    }
#endif // UI_NO_KEYBOARD
    ...
    if( last_state.channel.mode == OPMODE_FM )
    {
        ...
        gfx_print(layout.line1_pos, layout.top_font, TEXT_ALIGN_RIGHT, color_white, encdec_str);
    }
    else
    {
        if ( last_state.channel.mode == OPMODE_M17 )
        {
            char encdec_str[9] = "        ";
            gfx_print(layout.line1_pos, layout.top_font, TEXT_ALIGN_CENTER, color_white, encdec_str);
        }
    }
    // Second row
    // Calculate symmetric second row position, line2_pos is asymmetric like main screen
    point_t pos_2 = {layout.line1_pos.x, layout.line1_pos.y + (layout.line3_large_pos.y - layout.line1_pos.y)/2};
#ifdef UI_NO_KEYBOARD
    ...
    {
#endif // UI_NO_KEYBOARD
        gfx_print(pos_2, layout.top_font, TEXT_ALIGN_RIGHT, yellow_fab413, "6        ");
#ifdef UI_NO_KEYBOARD
    }
#endif // UI_NO_KEYBOARD
    gfx_print(pos_2, layout.top_font, TEXT_ALIGN_RIGHT, color_white, "%.1gW" , dBmToWatt(last_state.channel.power));
    // Third row
#ifdef UI_NO_KEYBOARD
    if( uiState->macro_menu_selected == 6 )
    {
#endif // UI_NO_KEYBOARD
        gfx_print(layout.line3_large_pos, layout.top_font, TEXT_ALIGN_LEFT, yellow_fab413, "7");
#ifdef UI_NO_KEYBOARD
    }
#endif // UI_NO_KEYBOARD
#ifdef SCREEN_BRIGHTNESS
    gfx_print(layout.line3_large_pos, layout.top_font, TEXT_ALIGN_LEFT, color_white, "   B-");
    gfx_print(layout.line3_large_pos, layout.top_font, TEXT_ALIGN_LEFT, color_white, "       %5d" , state.settings.brightness);
#endif
#ifdef UI_NO_KEYBOARD
    if( uiState->macro_menu_selected == 7 )
    {
#endif // UI_NO_KEYBOARD
        gfx_print(layout.line3_large_pos, layout.top_font, TEXT_ALIGN_CENTER, yellow_fab413, "8");
#ifdef UI_NO_KEYBOARD
    }
#endif // UI_NO_KEYBOARD
#ifdef SCREEN_BRIGHTNESS
    gfx_print(layout.line3_large_pos, layout.top_font, TEXT_ALIGN_CENTER, color_white,   "       B+");
#endif
#ifdef UI_NO_KEYBOARD
    if( uiState->macro_menu_selected == 8 )
    {
#endif // UI_NO_KEYBOARD
        gfx_print(layout.line3_large_pos, layout.top_font, TEXT_ALIGN_RIGHT, yellow_fab413, "9        ");
#ifdef UI_NO_KEYBOARD
    }
#endif // UI_NO_KEYBOARD
    if( uiState->input_locked == true )
    {
       gfx_print(layout.line3_large_pos, layout.top_font, TEXT_ALIGN_RIGHT, color_white, "Unlk");
    }
    else
    {
