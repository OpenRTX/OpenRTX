...
#endif
extern void _ui_drawSettingsAccessibilityPrompts(ui_state_t* ui_state);
...
bool ui_updateGUI()
{
    ...
    switch(last_state.ui_screen)
    {
        ...
        case SETTINGS_M17:
            ...
            break;
        case SETTINGS_ACCESSIBILITY:
            _ui_drawSettingsAccessibilityPrompts(&ui_state);
            break;
