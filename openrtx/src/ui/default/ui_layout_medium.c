...
const layout_t _layout_config = {
    ...
    .line1_symbol_size = SYMBOLS_SIZE_6PT,
    .line2_font = FONT_SIZE_6PT,
    .line2_symbol_size = SYMBOLS_SIZE_6PT,
    .line3_font = FONT_SIZE_6PT,
    .line3_symbol_size = SYMBOLS_SIZE_6PT,
    .line3_large_font = FONT_SIZE_10PT,
    .line4_font = FONT_SIZE_6PT,
    .line4_symbol_size = SYMBOLS_SIZE_6PT,
