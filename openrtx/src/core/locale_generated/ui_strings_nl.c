...
const stringsTable_t uiStrings = {
    ...
    .backupAndRestore  = "Backup & Herstellen",
    .info              = "Informatie",
    .about             = "Over",
    .display           = "Display",
    .timeAndDate       = "Datum & Tijd",
    .fm                = "FM",
    .m17               = "M17",
    .dmr               = "DMR",
    .defaultSettings   = "Fabrieksinstellingen",
    .brightness        = "Helderheid",
    .contrast          = "Contrast",
    .timer             = "Timer",
    .gpsEnabled        = "GPS Enabled",
    .gpsSetTime        = "GPS Set Time",
    .UTCTimeZone       = "UTC Tijdzone",
    .voice             = "Stem",
    .level             = "Level",
    .phonetic          = "Phonetic",
    .beep              = "Beep",
    .backup            = "Backup",
    .restore           = "Herstel",
    .batteryVoltage    = "Bat. Spanning",
    .batteryCharge     = "Bat. Lading",
    .RSSI              = "RSSI",
    .model             = "Model",
    .band              = "Band",
    .VHF               = "VHF",
