          ...
          "[m17][disassembler]")
{
    ...
    size_t n = assembleAll(appData, 2, frames, 4);
    REQUIRE(n == 1);
    ...
    n = assembleAll(appData2, 3, frames2, 4);
    REQUIRE(n == 1);
          ...
          "[m17][disassembler]")
{
    ...
    PacketFrame frames[4];
    size_t n = assembleAll(appData, 3, frames, 4);
    REQUIRE(n == 1);
          ...
          "[m17][disassembler]")
{
    ...
    PacketFrame frames[4];
    size_t n = assembleAll(appData, 11, frames, 4);
    REQUIRE(n == 1);
          ...
          "[m17][disassembler]")
{
    ...
    PacketFrame frames[4];
    size_t n = assembleAll(appData, 26, frames, 4);
    REQUIRE(n == 2);
          ...
          "[m17][disassembler]")
{
    ...
    PacketFrame frames[4];
    size_t n = assembleAll(appData, 55, frames, 4);
    REQUIRE(n == 3);
          ...
          "[m17][disassembler]")
{
    ...
    PacketFrame frames[4];
    size_t n = assembleAll(appData, 5, frames, 4);
    REQUIRE(n == 1);
          ...
          "[m17][disassembler]")
{
    ...
    PacketFrame frames[4];
    size_t n = assembleAll(appData, 6, frames, 4);
    REQUIRE(n == 1);
          ...
          "[m17][disassembler]")
{
    ...
    PacketFrame frames[4];
    size_t n = assembleAll(appData, 25, frames, 4);
    REQUIRE(n == 2);
...
TEST_CASE(
    "Round-trip: single-frame SMS through PacketAssembler + PacketDisassembler",
    "[m17][integration]")
{
    // TX side: build frames
    uint8_t appData[16] = { 0x05, 'O', 'p', 'e', 'n', 'R', 'T', 'X', 0x00 };
    PacketFrame frames[4];
    size_t n = assembleAll(appData, 9, frames, 4);
    REQUIRE(n > 0);
...
TEST_CASE(
    "Round-trip: multi-frame packet through PacketAssembler + PacketDisassembler",
    "[m17][integration]")
{
    ...
    size_t n = assembleAll(appData, 100, frames, 8);
          ...
          "[m17][integration]")
{
    ...
    size_t n = assembleAll(appData, 823, frames, 33);
    REQUIRE(n == 33);
