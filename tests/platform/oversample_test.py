...
def main():
    parser = argparse.ArgumentParser(description="Read audio data from microcontroller, save to CSV and WAV.")
    parser.add_argument("filename_base", type=str, help="Base filename for CSV and WAV files (e.g., 'audio_capture')")
    parser.add_argument("--port", type=str, default="/dev/ttyACM", help="Serial port (e.g., /dev/ttyACM0 or COM3)")
    ...
    parser.add_argument("--samplerate", type=int, default=8000, help="Sample rate of the microphone in Hz")
