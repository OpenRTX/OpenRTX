...
# 4. Refer to the `symbols/enums.h` file to find the enum that corresponds with your new symbol
...
with open(os.path.join(absolute_path, "../openrtx/include/fonts/symbols/enums.h".format(size)), "w") as f:
    out = dont_edit_banner
    out += "enum symbol_names {\n"
