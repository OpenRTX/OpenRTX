...
#ifndef EMULATED_FLASH_H
#define EMULATED_FLASH_H
...
/**
 * Instantiate an emulated flash storage NVM device.
 *
...
#define EMULATED_FLASH_DEVICE_DEFINE(name)      \
    static struct nvmFileDevice file_##name = { \
        .ops = &posix_file_ops,                 \
    ...
    static struct nvmDevice name = {            \
        .priv = &file_##name,                   \
        .ops = &emulated_flash_ops,             \
        .info = &emulated_flash_info,           \
    };
